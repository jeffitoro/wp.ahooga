...
lib.ssMetadata = [
		{name:"modular_bike_header_normal_atlas_", frames: [[1002,668,1000,539],[1002,0,1000,666],[0,967,1000,375],[0,0,1000,965]]}
];
...
(lib._20180831_Ahooga_Lafabrique22a_0015resized = function() {
	this.spriteSheet = ss["modular_bike_header_normal_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.modular_bike_header_normal = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/modular_bike_header_normal_atlas_.png", id:"modular_bike_header_normal_atlas_"}
	],
	preloads: []
};
