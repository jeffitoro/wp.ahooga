...
lib.ssMetadata = [
		{name:"modular_bike_header_resp_final_atlas_", frames: [[1002,0,1004,594],[1002,596,1000,539],[0,967,1000,375],[0,0,1000,965]]}
];
...
(lib._2 = function() {
	this.spriteSheet = ss["modular_bike_header_resp_final_atlas_"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/modular_bike_header_resp_final_atlas_.png", id:"modular_bike_header_resp_final_atlas_"}
	],
	preloads: []
};
