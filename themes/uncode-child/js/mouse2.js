...
// stage content:
(lib.mouse2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Calque_2
	this.instance = new lib.Symbole1();
	this.instance.parent = this;
	this.instance.setTransform(16.4,13.7,0.101,0.101,0,0,0,194.8,75.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(12,15,16.2,25.8);
// library properties:
lib.properties = {
